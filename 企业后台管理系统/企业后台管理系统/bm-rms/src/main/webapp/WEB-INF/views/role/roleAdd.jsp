    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;" >
        <form id="roleAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>角色名称</td>
                    <td><input name="name" autocomplete="off" type="text" placeholder="请输入角色名称" class="easyui-validatebox span2" data-options="required:true"></td>
                </tr>
                <tr>
                    <td>排序</td>
                ...
                <tr>
                    <td>描述</td>
                    <td colspan="3"><textarea name="description" style="padding-left: 4px" rows="" cols="" ></textarea></td>
                </tr>
            </table>
        </form>
    </div>
