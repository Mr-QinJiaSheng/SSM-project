...
<ul class="layui-nav layui-bg-blue">
    ...
    <li class="layui-nav-item"><a href="<%=basePath%>student/studentInfo?stuid=${sessionScope.stuid}"
                                  style="font-size:20px;">个人资料</a></li>
    ...
    <li class="layui-nav-item" style="float:right; font-size:20px;"><em class="layui-icon" style="font-size:18px;">&#xe612;</em>&nbsp;${sessionScope.username}&nbsp;
    </li>
</ul>
