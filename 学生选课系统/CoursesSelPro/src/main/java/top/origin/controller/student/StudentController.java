package top.origin.controller.student;
...
public class StudentController {
    ...
    public String searchListByTeaId(@Param("teaid") int teaid, @Param("stuid") int stuid, Model model) {
        List<Course> cor_list = courseService.queryAllById(teaid, stuid);
        model.addAttribute("paging", pageService.subList(1, cor_list));
        model.addAttribute("teaList", userService.queryAllTeacher());
        Teacher t = userService.getTeaInfoById(teaid);
        model.addAttribute("teaname", t.getTeaName());
        model.addAttribute("insList", courseService.queryAllIns());
        return "student/courseList";
    }

    @RequestMapping("/searchListByInsId")
    public String searchListByInsId(@Param("insid") int insid, @Param("stuid") int stuid, Model model) {
        List<Course> cor_list = courseService.queryAllByInsId(insid, stuid);
        model.addAttribute("paging", pageService.subList(1, cor_list));
        model.addAttribute("teaList", userService.queryAllTeacher());
        model.addAttribute("insList", courseService.queryAllIns());
        return "student/courseList";
